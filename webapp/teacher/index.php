...
if (isset($_GET["c"])){unset($_SESSION["teacher_webapp"]);}
if (isset($_SESSION["teacher_webapp"])){header("Location: checkAttendance.php");}
?>
...
<form action="#" id="teacherLogin" class="login">
